...
//			view.setViewName(BaseViewConstant.seekingJob404);
		} else if("dev".equals(systemConstantService.getSysValByName(SystemConstantStore.envName, true))){
			view.setViewName(BaseViewConstant.normal404);
		} else {
	...
	private boolean findDebugStatus() {
		String debugStatusStr = systemConstantService.getSysValByName(SystemConstantStore.debugStatus);
