...
//	private static final String ROOT_FOR_BBT = System.getProperty("user.home") + "/optionFile/bbt";
	...
	public static final String ARTICLE_COMMENT = ROOT + "/articleComment/option.json";
	public static final String MAIL = ROOT + "/mail/option.json";
	...
	public static final String CRYPTO_COIN_SYMBOL_MAX_LEVERAGE_INFO = ROOT + "/cryptoCoin/symbolMaxLeverageInfo.json";
	...
	public static final String WECHAT_PAY = ROOT + "/wechatPay/option.json";
	public static final String AI_COMMON = ROOT + "/aiCommon/option.json";
	public static final String AI_CHAT = ROOT + "/aiChat/option.json";
