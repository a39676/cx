...
public class AccountInfoController extends CommonController {
	...
	public ModelAndView accountDetail(@RequestBody AccountInfoDetailQueryDTO dto) {
		...
		try {
			...
			AccountInfoWithBankInfo accountInfoWithBankInfo = accountInfoService
					.getAccountInfoWithBankInfoByAccountNumber(dto.getAccountNumber());
			view.addObject("account", accountInfoWithBankInfo);

			List<AccountInfo> affiliationAccounts = accountInfoService
					.getAllAffiliatedAccountByAffiliationId(accountInfoWithBankInfo.getAccountId());
			if (affiliationAccounts != null && !affiliationAccounts.isEmpty()) {

				view.addObject("affiliationList", affiliationAccounts);

				HashMap<String, String> affiliationSum = accountInfoService
						.sumAffiliatedAccountInfo(affiliationAccounts);
	...
	public ModelAndView accountListView(@RequestBody GetAccountListByConditionParam param) {
		...
		List<BillInfoCustomDetail> billInfoList = creditbillController
				.getBillCustomDetailByAccountInfoWithBankInfo(accountList);
	...
	@ResponseBody
	public GetAccountListResult accountList(@RequestBody GetAccountListByConditionParam param,
	...
	@ResponseBody
	public CommonResult accountNumberDuplicateCheck(@RequestBody AccountNumberDuplicateCheckDTO dto)
			throws IOException {
	...
	@ResponseBody
	public CommonResult modifyCreditsQuota(@RequestBody ModifyCreditsQuotaDTO dto, HttpServletResponse response)
			throws IOException {
