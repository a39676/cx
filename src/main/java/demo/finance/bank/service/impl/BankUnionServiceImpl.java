...
import demo.finance.bank.mapper.BankUnionMapper;
...
import demo.finance.bank.pojo.po.example.BankUnionExample.Criteria;
...
public class BankUnionServiceImpl implements BankUnionService {
	...
	@Autowired
	private BankUnionMapper bankUnionMapper;
