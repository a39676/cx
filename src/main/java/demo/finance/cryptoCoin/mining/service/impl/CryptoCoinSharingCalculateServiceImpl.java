...
import demo.finance.cryptoCoin.mining.pojo.po.CryptoCoinShareExample.Criteria;
...
import demo.finance.cryptoCoin.mining.pojo.vo.CryptoCoinMachineInfoVO;
import demo.finance.cryptoCoin.mining.pojo.vo.CryptoCoinMiningMachineVO;
import demo.finance.cryptoCoin.mining.pojo.vo.CryptoCoinShareVO;
...
public class CryptoCoinSharingCalculateServiceImpl extends CryptoCoinCommonService
	...
	public CryptoCoinShareCalculateResult getCalculateResult(CryptoCoinShareCalculateDTO dto) {
		...
		if (StringUtils.isBlank(dto.getMachinePK())) {
			return result;
		}
