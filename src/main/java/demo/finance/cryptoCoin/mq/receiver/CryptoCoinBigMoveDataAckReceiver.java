...
@Component
@RabbitListener(queues = CryptoCoinMQConstant.CRYPTO_COIN_BIG_MOVE_DATA)
public class CryptoCoinBigMoveDataAckReceiver extends CommonMessageQueueReceiverService {
