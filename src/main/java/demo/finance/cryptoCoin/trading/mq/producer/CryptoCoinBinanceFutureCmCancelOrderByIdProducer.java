...
@Component
public class CryptoCoinBinanceFutureCmCancelOrderByIdProducer extends CommonService {
	...
	public void sendCancleOrder(CryptoCoinBinanceFutureCmCancelOrderByIdDTO dto) {
		...
		rabbitTemplate.convertAndSend(CryptoCoinMQConstant.BINANCE_CM_FUTURE_CANCEL_ORDER_BY_ID, json.toString());
	}
