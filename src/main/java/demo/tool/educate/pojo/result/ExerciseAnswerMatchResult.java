...
public class ExerciseAnswerMatchResult extends CommonResult {
	...
	private Long timeConsumingMinute;
	...
	public Long getTimeConsumingMinute() {
		return timeConsumingMinute;
	}

	public void setTimeConsumingMinute(Long timeConsumingMinute) {
		this.timeConsumingMinute = timeConsumingMinute;
	}

	@Override
	public String toString() {
		return "ExerciseAnswerMatchResult [totalScore=" + totalScore + ", points=" + points + ", matchGradeType="
				+ matchGradeType + ", wrongNumberList=" + wrongNumberList + ", questionListSize=" + questionListSize
				+ ", answerMap=" + answerMap + ", timeConsumingMinute=" + timeConsumingMinute + "]";
	}
