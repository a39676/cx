...
public class TelegramShippingAddressDTO {
	...
	public String toString() {
		return "TelegramShippingAddressDTO [country_code=" + country_code + ", state=" + state + ", city=" + city
				+ ", street_line1=" + street_line1 + ", street_line2=" + street_line2 + ", post_code=" + post_code
				+ "]";
	}
