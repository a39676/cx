...
public class TelegramUserDTO {
	...
	public String toString() {
		return "TelegramUserDTO [id=" + id + ", is_bot=" + is_bot + ", first_name=" + first_name + ", last_name="
				+ last_name + ", username=" + username + ", language_code=" + language_code + ", is_premium="
				+ is_premium + ", added_to_attachment_menu=" + added_to_attachment_menu + ", can_join_groups="
				+ can_join_groups + ", can_read_all_group_messages=" + can_read_all_group_messages
