...
@Service
public class ExerciseServiceMathG3_2Impl extends ExerciseMathCommonService implements ExerciseServiceMathG3_2 {
	...
	public static void main(String[] args) {
		ExerciseServiceMathG3_2Impl t = new ExerciseServiceMathG3_2Impl();
		int i = 0;
		while (i < 10) {
