...
//
//import demo.toyParts.educate.pojo.dto.BaseSimpleMutiplyDTO;
...
//	private static final Integer MIN_MULTIPLICATION_NUM = 2;
...
//	}
//	
//	private Expression createDivision() {
//		ThreadLocalRandom t = ThreadLocalRandom.current();
//		
//		int multiplication_1 = t.nextInt(MIN_MULTIPLICATION_NUM, MAX_MULTIPLICATION_NUM + 1);
//		int multiplication_2 = t.nextInt(MIN_MULTIPLICATION_NUM, MAX_MULTIPLICATION_NUM + 1);
//		String exp1 = String.valueOf(multiplication_1 + MathBaseSymbolType.multiplication.getCodeSymbol() + multiplication_2);
//		Expression expression1 = new ExpressionBuilder(exp1).build();
//		Double result2 = expression1.evaluate();
//		
//		exp1 = String.valueOf(result2 + MathBaseSymbolType.division.getCodeSymbol() + multiplication_1);
