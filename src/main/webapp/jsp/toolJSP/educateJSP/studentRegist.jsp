...
<body>
  ...
  <div  class="col-md-12" id="registForm">
    ...
    <div class="form-group">
      <span name="gradeType" >年级<span style='color: rgb(255, 0, 0);font-weight: bold;'>*</span></span>
      <select class="form-control" name="" id="gradeType">
        <c:forEach items="${gradeTypeList}" var="gradeType">
          <option value="${gradeType.code}">${gradeType.name}</option>
        </c:forEach>
      </select>
      <span id="gradeTypeWarnMsg" style='color: rgb(255, 0, 0);font-weight: bold;'></span>
    </div>
